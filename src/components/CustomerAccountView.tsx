...
export const CustomerAccountView: React.FC<CustomerAccountViewProps> = ({ 
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 text-left text-slate-900 dark:text-slate-100">
      ...
      {/* Top Required Heading */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight">Customer Dashboard</h1>
          <p className="text-xs text-slate-500 dark:text-slate-400">Manage your orders, digital library, wishlist alerts, and account preferences.</p>
        </div>
        <span className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/30 w-fit">
          Customer Portal
        </span>
      </div>
